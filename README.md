Clone os dois repositórios em pastas diferentes. Após isso instale o MySQL. No arquivo application.properties, troque as credenciais que estão pelas suas criadas na instalação do MySQL. 
